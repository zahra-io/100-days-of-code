...
### Day 26: December 24, 2017

**Today's Progress:** I read up some lessons in Computer Science on Khan Academy today. I learned about Algorithms and Binary Search. I THINK I understand what they are. An algorithm is a set of steps that a computer has to take in order to solve a problem or complete a task. Binary search is splitting a set of steps in half in order to find the correct item that the program contains. Binary Search makes the program more efficient. I also wrote a blog post about what I learned / reiterating the lesson and repeating it back to myself: [zahrareine.wordpress.com](https://zahrareine.wordpress.com/)

**Thoughts:** I'm SO scared lol. Algorithms, Binary Search, Binary System, Linear Search, etc, are all so interesting but so complex. I'm nervous that I won't ever fully understand it. But reading up on these concepts is definitely strengthening my knowledge in programming because it's helping me understand the WHY in code, which I definitely didn't understand before. The kind of learner I am is that I have to understand the root of a problem in order to solve it. I now understand why theory and logic is so important to apply to programming languages. Thinking about how methods are applied in my daily life helped me think about them differently.
