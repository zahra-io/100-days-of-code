...
**Today's Progress:** I read up some lessons in Computer Science on Khan Academy today. I learned about Algorithms and Binary Search. I THINK I understand what they are. An algorithm is a set of steps that a computer has to take in order to solve a problem or complete a task. Binary search is splitting a set of steps in half in order to find the correct item that the program contains. Binary Search makes the program more efficient. I also wrote a blog post about what I learned / reiterating the lesson and repeating it back to myself: [zahrareine.wordpress.com](zahrareine.wordpress.com)
